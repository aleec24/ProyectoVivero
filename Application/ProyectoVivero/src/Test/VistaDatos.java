...
public class VistaDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtNombre.setText("prueba1");

        txtPrimerapellido.setText("prueba2");

        txtCedula.setText("jTextField4");
...
if(guardar){
   ...
   control.insertar(id, nombre, primerapellido, cedula, telefono, correo);
   txtId.setText("0");
   txtNombre.setText("");
